...
export class ClienteService {
  ...
  private clienteUrl = 'http://10.101.151.25:3010/catalog/cliente';  // URL to web api
  private clienteCreateUrl = 'http://10.101.151.25:3010/catalog/clientes/create';  // URL to web api
